        ...
        <div class="container">
          ...
          <div class="bread__content">
            ...
            <h1 class="bread__title">
              Баня из бруса  <?php the_field('size'); ?> <?php the_title(); ?>
            </h1>
            <?php
        ...
        <div class="container">
          <div class="project-inner__content">
                  ...
                  <?php if(have_rows('galereya')): ?>
                    <?php while(have_rows('galereya')): the_row(); ?>
                        <div class="swiper-slide">
                          <img loading="lazy" src="<?php the_sub_field('galereya-img'); ?>" class="image" width="740" height="570" alt="img">
                        </div>
                    <?php endwhile; ?>
                  <?php endif; ?>
              ...
              <div class="swiper project-inner__thumbs">
                <div class="swiper-wrapper">
                  ...
                  <?php if(have_rows('galereya')): ?>
                    <?php while(have_rows('galereya')): the_row(); ?>
                        <div class="swiper-slide">
                          <img loading="lazy" src="<?php the_sub_field('galereya-img'); ?>" class="image" width="130" height="105" alt="img">
                        </div>
                    <?php endwhile; ?>
                  <?php endif; ?>
            ...
            <div class="project-inner__box">
              <p class="project-inner__name">Дом из бруса <?php the_field('size'); ?> <?php the_title(); ?></p>
              ...
              <div class="project-inner__block">
                  <button class="btn-reset project-inner__btn" data-graph-path="modal">Расчёт
                    <svg width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3.16659 11H13.8333M13.8333 11L9.83325 15M13.8333 11L9.83325 7" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </button>
                  <a href="/materinskiy-capital/" class="project-inner__link">Маткапитал
                    <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M2.66659 11H13.3333M13.3333 11L9.33325 15M13.3333 11L9.33325 7" stroke="#020202" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </a>
                </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="tabs" data-tabs="info">
            ...
            <div class="project-info__nav">
              <span class="project-info__key ">Под ключ</span>
              <span class="project-info__ysad project-info__ysad--active">Под усадку</span>
            </div>
            <div class="tabs__wrapper">
              <ul class="list-reset tabs__nav">
                <li class="tabs__nav-item"><button class="btn-reset tabs__nav-btn" type="button">90x140</button></li>
                  ...
                  <div class="project-info__content">
                    ...
                    <div class="project-info__row">
                      ...
                      <p class="project-info__text">
                        профилированный брус естественной влажности 90х140 мм.
                        между венцами прокладывается льноджутовое полотно,
                        углы сруба собираются способом "в тёплый угол" (по акции) ,
                        сруб собирается на деревянные нагели.
                      </p>
                    </div>
                    <div class="project-info__row">
                      <p class="project-info__name">
                    ...
                    <div class="project-info__row">
                      ...
                      <p class="project-info__text">
                       двойная из бруса 100х150 мм./150х150 мм.
                      </p>
                    </div>
                    <div class="project-info__row">
                      <p class="project-info__name">
                    ...
                    <div class="project-info__row">
                      ...
                      <p class="project-info__text">
                        выполняются по каркасно-щитовой технологии, каркас 40*100 мм./40*150 мм. , снаружи
                        обиваются имитацией бруса. Устанавливаются вентиляционные решетки.
                      </p>
                    </div>
                    <div class="project-info__row">
                      <p class="project-info__name">
                        Перегородки на мансарде
                      </p>
                      <p class="project-info__text">
                        -
                      </p>
                    ...
                    <div class="project-info__row">
                      <p class="project-info__name">
                       Потолки 1-го этажа, мансарда подшиваются вагонкой
                      </p>
                      <p class="project-info__text">
                        -
                      </p>
                    ...
                    <div class="project-info__row">
                      ...
                      <p class="project-info__text">
                        брус 40х100 мм./40*150 мм. (в зависимости от проекта*) (шаг 59 см.)
                      </p>
                    </div>
                    <div class="project-info__row">
                      <p class="project-info__name">
                    ...
                    <div class="project-info__row">
                      ...
                      <p class="project-info__text">
                        одноэтажные дома: от 2 м.
                        проекты с мансардой: от 3.3 м. до 4.0 м., в зависимости от проекта
                      </p>
                    </div>
                    <div class="project-info__row">
                      <p class="project-info__name">
                        Углы, поднебесники и карнизы
                          обиваются имитацией бруса
                      </p>
                      <p class="project-info__text">
                        кроме углов
                      </p>
                    ...
                    <div class="project-info__row">
                      ...
                      <p class="project-info__text">
                        Ондулин, цвет на выбор: бордовый, коричневый, зелёный, по подкровельной плёнке 
                      </p>
                    </div>
                    <div class="project-info__row">
                      <p class="project-info__name">
                        Вынос кровли (поднебесники, карнизы)
                      </p>
                      <p class="project-info__text">
                        45-50 см.
                      </p>
                    ...
                    <div class="project-info__row">
                      <p class="project-info__name">
                        Террасное и балконное ограждение
                      </p>
                      <p class="project-info__text">
                        при наличии, без балясин и перил.
                      </p>
                    </div>
                    <div class="project-info__row">
                      <p class="project-info__name">
